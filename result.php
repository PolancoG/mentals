...
<head>
    ...
    <link rel="shortcut icon" href="./assets/icons/users_2.ico" type="image/x-icon">
            ...
            <div class="content-container">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <!-- /.row -->
                        <h1><span class="blue">&lt; </span>Resultados<span class="blue"></span> <span class="yellow">Calificaciones &gt;</pan> 
                        </h1>
                        <h2>Se muestran los datos y resultados de las calificaciones del estudiante</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                            ...
                                            <div class="panel-title">
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        <p><b>Estudiante ID:</b> <?php echo htmlentities($row->RollId); ?>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            ...
                                                            <div class="alert alert-danger left-icon-alert" role="alert">
                                                               <strong>Tenemos problemas con la busqueda: </strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp***
                                                            <?php
                                                            echo htmlentities("ID Roll y/o Año-sección inválido(s) ***"); 
                                                        }
                                                            ?> 
                                                            </div>
                                                    </tbody>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="find-result.php" class="volver"><strong>Volver</strong></a>
                                        </div><br>
                                    </div>
