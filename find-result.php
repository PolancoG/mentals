...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/icons/users_2.ico">
                    ...
                    <div class="panel login-box" style="    background: #3d86ed;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <img style="height: 90px" src="assets/icons/users_2.ico">
                                </a>
                        ...
                        <div class="panel-body p-20">
                            <form action="result.php" method="post" class="admin-login">
                                <div class="form-group">
                                    <label for="rollid" class="control-label">Ingrese su estudiante ID</label>
