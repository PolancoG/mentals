...
<head>
   ...
   <link rel="icon" type="image/x-icon" href="assets/icons/user.ico">
         ...
         <div class="row">
            <div class="col-md-offset-7 col-lg-5">
               <section class="section">
                  <div class="row mt-10">
                     <div class="col-md-offset-2 col-md-10  pt-40">
                        <div class="row mt-8 ">
                           <div class="col-md-11">
                              <div class="panel login-box" style="    background: #3d86ed;">
                                 <div class="panel-heading">
                                    <div class="text-center"><br>
                                       <a href="#">
                                       <img style="height: 90px" src="assets/icons/user.ico"></a>
                                       <h5 style="color: white;"> <strong>Acceso Administrativo al Sistema</strong></h5>
                                    </div>
                                 </div>
